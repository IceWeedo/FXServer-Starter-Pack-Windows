...
* #### FXServer:
  ...
  * Dans **server.cfg** section **# Add system admins** ajouter la ligne
    * Utilisateur Steam **add_principal identifier.steam:xxxxxxxxxxxxxx group.admin**
    * Utilisateur non-Steam **add_principal identifier.license:xxxxxxxxxxxxxxxxxxxxxxxxxxxx group.admin**
